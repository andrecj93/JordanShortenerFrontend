...
import WizardLinkShortener from "../views/pages/urlShortenerWizard/ShortenerWizard.vue";

const routes = [
  {
    path: '/',
    name: 'Home',
    redirect: '/applications/shortener-wizard',
  },
  {
  ...
  {
    path: '/applications/shortener-wizard',
    name: 'ShortenerWizard',
    component: WizardLinkShortener,
  },
  {
